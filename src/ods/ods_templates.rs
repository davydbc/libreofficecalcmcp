...
impl OdsTemplates {
    const EMPTY_CALC_TEMPLATE: &'static [u8] = include_bytes!("assets/empty_calc.ods");

    // Embedded empty ODS generated by LibreOffice Calc.
    pub fn empty_calc_template() -> &'static [u8] {
        Self::EMPTY_CALC_TEMPLATE
    }
